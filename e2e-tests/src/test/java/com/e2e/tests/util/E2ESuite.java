...
public class E2ESuite {
    ...
    static class Initializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
        ...
        public void initialize(ConfigurableApplicationContext context) {
            ...
            serviceDiscoveryContainer = new GenericContainer<>("darwinl06/service-discovery:latest")
                    .withNetwork(network)
            ...
            cloudConfigContainer = new GenericContainer<>("darwinl06/cloud-config:latest")
                    .withNetwork(network)
            ...
            userServiceContainer = new GenericContainer<>("darwinl06/user-service:latest")
                    .withNetwork(network)
            ...
            paymentServiceContainer = new GenericContainer<>("darwinl06/payment-service:latest")
                    .withNetwork(network)
            ...
            favouriteServiceContainer = new GenericContainer<>("darwinl06/favourite-service:latest")
                    .withNetwork(network)
